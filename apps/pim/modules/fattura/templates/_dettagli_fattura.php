...
<div class="actions nofixed" style="margin-right: 0px;height: 19px;">
<ul>
<li  class="last">
<input type="image" name="pippo" src="<?php echo $sf_request->getRelativeUrlRoot()?>/	images/icons/page_new.gif" onClick="this.form.insert_page.value='yes'"/>
</li>
</ul>
</div>

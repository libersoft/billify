...
<th>Num fattura:</th>
<td>
<?php echo object_input_tag($fattura,'getNumFattura',array('size' => 4))?>
</td>
...
<tr>
  ...
  <?php echo input_hidden_tag('num_fattura',$fattura->getNumFattura());?></td>
</tr>
<?php endif ?>
<?php else:?>
...
<tr>
  <th>Cliente:</th>
  <td><?php echo link_to($cliente->toString(),'cliente/show?id='.$cliente->getID())?>
  <?php echo input_hidden_tag('cliente_id',$cliente->getID());?>
  </td>
</tr>
<?php else: ?>
<tr>
...
<tr>
  ...
  <?php echo input_hidden_tag('data',format_date($fattura->getData()))?></td>
</tr>
<?php endif?>
<tr>
  <th>Modo pagamento id:</th>
  <td><?php echo object_select_tag($fattura, 'getModoPagamentoId', array('related_class' => 'ModoPagamento')) ?>gg</td>
</tr>
<tr>
  <th>Sconto:</th>

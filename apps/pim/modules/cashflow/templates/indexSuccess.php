...
<table class="fatture">
  ...
  <?php foreach ($rows as $row) : ?>
    <tr>
      ...
      <td><?php echo $row instanceof  CashIncome ? format_currency($row->getImponibile(), '&euro;') : '' ?></td>
      <td><?php echo $row instanceof CashOutcome ? format_currency($row->getImponibile(), '&euro;') : ''?></td>
    </tr>
  <?php endforeach; ?>
</table>

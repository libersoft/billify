...
/**
 * Class to adapt sales invoice bahaviour to cash flow behaviour
 * 
 ...
 *
 */
Class CashFlowSalesAdapter extends AbstractCashFlowAdapter implements ICashFlowAdapter 
{
 ...
 /**
  ...
  /**
   * Retrieve sales invoice color state;
   *
   * @return string
   */
  ...
  /**
   * Retrieve sales invoice payment date
   *
   */

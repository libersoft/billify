...
/**
 * Contatto form base class.
 *
 * @package    form
 * @subpackage contatto
 * @version    SVN: $Id: sfPropelFormGeneratedTemplate.php 8807 2008-05-06 14:12:28Z fabien $
 */
class BaseContattoForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'contatto'                 => new sfWidgetFormInput(),
    ...
    $this->setValidators(array(
      'id'                       => new sfValidatorPropelChoice(array('model' => 'Contatto', 'column' => 'id', 'required' => false)),
      ...
      'nazione'                  => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      ...
      'contatto'                 => new sfValidatorString(array('max_length' => 255, 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('contatto[%s]');
